...
const app = axf.utils.createKoaServer('/', path.resolve(__dirname ,'../..', 'dist/cweb'));

//输出首页
let IndexHTML;

if (process.env.NODE_ENV === 'production') {
	IndexHTML=require('fs').readFileSync(path.resolve(__dirname,'../../','dist/cweb/index.html'), 'utf8');
}
